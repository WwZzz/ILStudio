...
| ACT - Insertion                              | ACT - Transfer Cube                        | ACT - Transfer Cube                        |
|----------------------------------------------|--------------------------------------------|--------------------------------------------|
| ![ACT-Aloha](assets/act_aloha_insertion.gif) | ![ACT-Aloha](assets/act_transfer_cube.gif) | ![ACT-Aloha](assets/act_transfer_cube.gif) |
