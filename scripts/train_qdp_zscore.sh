...
OUTPUT=./qdp_zscore_2 # Notice a standard OUTPUT dir should include key words "lora" and "qwen2_vl" for better load model(e.g. /root/path/lora_qwen2_vla_factory_sorting)

deepspeed --master_port 29604 --num_gpus=4 --num_nodes=1 ./train.py \
