...
POLICYCONFIG=configs/policy/diffusion_policy.yaml # the policy config file path
...
OUTPUT=ckpt/dp_${TASKNAME}_${NORM}_example # the checkpoint name that will be used for evaluation
