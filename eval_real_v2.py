...
from deploy.action_manager import BasicActionManager, TemporalAggManager, DelayFreeManager
...
class HyperArguments:
    ...
    action_buffer_size: int = field(default=1)
    ...
    # ############ action manager ##########
    action_manager: str = 'temporal'
    temporal_coef: float = 0.1
    duration: float = 0.05
...
if __name__ == '__main__':
    ...
    # init action manager
    if args.action_manager=='base': 
        action_manager = BasicActionManager(args)
    elif args.action_manager=='temporal':
        action_manager = TemporalAggManager(args)
    elif args.action_manager=='delayfree':
        action_manager = DelayFreeManager(args)
